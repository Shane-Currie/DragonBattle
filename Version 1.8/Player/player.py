from WorldMap.Control.map import Map
from WorldMap.KekistanCity.BurrowsNeighbourhood.burrows_home import burrows_home 
...
class Player:
    def __init__(self, name):
        ...
        #should include the players current experence points
        #should include player level value, where the player will advance a level based on expereince points
